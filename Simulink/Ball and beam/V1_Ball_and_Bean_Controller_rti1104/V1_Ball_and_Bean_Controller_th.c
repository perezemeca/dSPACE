/************************ dSPACE target specific file *************************
   ...
   Include file .\V1_Ball_and_Bean_Controller_rti1104\V1_Ball_and_Bean_Controller_th.c :

   Task Configuration file for model : V1_Ball_and_Bean_Controller

   RTI1104 7.3 (02-Nov-2014)/2.6
   13-Sep-2022 12:08:07
...
# ifdef MULTITASKING
#   error Cannot compile in multiple timer tasks mode (.\V1_Ball_and_Bean_Controller_rti1104\V1_Ball_and_Bean_Controller_th.c is for ST).
# endif
